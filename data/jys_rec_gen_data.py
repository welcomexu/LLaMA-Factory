...
def gen_user_content():
    user_contents = [
        ...
        "识别图片中的文本",
        "提取图片中的文本",
        "你是一个OCR专家，帮我识别一下图片中的文字",
        "你能帮我识别一下图片中的文字吗",
        "你能帮我提取一下图片中的文字吗",
        "你能帮我提取一下图片中的文字内容吗",
        "你能帮我提取一下图片中的文字信息吗",
        "你是一个OCR专家，你的任务是识别图片中的文字",
        "你是一个OCR专家，你的任务是提取图片中的文字",
        "你是一个OCR专家，你的任务是提取图片中的文字内容",
        "你是一个OCR专家，你的任务是提取图片中的文字信息",
        "你是一个OCR专家，你的任务是识别图片中的文字内容",
        "作为一个OCR专家，你的任务是识别图片中的文字",
        "作为一个OCR专家，你的任务是提取图片中的文字",
        "作为一个OCR专家，你的任务是提取图片中的文字内容",
        "作为一个OCR专家，你的任务是提取图片中的文字信息",
        "作为一个OCR专家，你的任务是识别图片中的文字内容",
        "作为一个OCR专家，你的任务是提取图片中的文本",
        "作为一个OCR专家，你的任务是提取图片中的文本内容",
        "作为一个OCR专家，你的任务是提取图片中的文本信息",
        "作为一个OCR专家，你的任务是识别图片中的文本",
        "作为一个OCR专家，你的任务是提取图片中的文本内容"
    ]
